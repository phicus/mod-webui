...
<div id="hostsgroups">
   ...
   <ul id="groups" class="list-group">
      ...
      %if level==0:
         ...
         <li class="well all_groups list-group-item clearfix {{even}} {{'alert-danger' if h['nb_elts'] == h['nb_down'] and h['nb_elts'] != 0 else ''}}">

           <section class="col-md-3 col-sm-2 col-xs-8">
            <h4>
