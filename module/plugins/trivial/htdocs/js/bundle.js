...
/******/ 	return __webpack_require__(__webpack_require__.s = "./trivial/trivial2.0.js");
/******/ })
/************************************************************************/
/******/ ({
...
/*!****************************************************************************!*\
  !*** /home/pajaro/src/github/mod-webui/node_modules/jquery/dist/jquery.js ***!
  \****************************************************************************/
...
var Trivial = function () {
    function Trivial() {
        ...
        _classCallCheck(this, Trivial);

        var txt = (0, _jquery2.default)('#txtSearch').val();
        (0, _jquery2.default)('#search').val(txt);
        history.pushState('trivial:' + txt, 'Trivial: ' + txt, '/trivial?search=' + txt);
        _jquery2.default.getJSON("trivial.json?search=" + txt, function (data) {
            _this2.trivial_init(data);
        });
    }

    _createClass(Trivial, [{
        key: 'trivial_init',
        value: function trivial_init(data) {
            var _this3 = this;
        ...
        value: function expand() {
            ...
            // The this of this callback function will be this this
            // instead of its own this
            // There is a lot of this, lol
            _jquery2.default.getJSON("trivial.json?search=" + txt, function (data) {
                console.log(data);
                _this4.cy.add(data);
            });
        ...
        key: 'workMode',
        value: function workMode() {
            (0, _jquery2.default)('#load-position').show();
            (0, _jquery2.default)('#save-position').show();
            (0, _jquery2.default)('#view-mode').show();
            (0, _jquery2.default)('#work-mode').hide();
            this.cy.nodes().unlock();
            (0, _jquery2.default)('#trivial').css('background-color', '#f3c019');
        }
    }, {
        key: 'viewMode',
        value: function viewMode() {
            (0, _jquery2.default)('#load-position').hide();
            (0, _jquery2.default)('#save-position').hide();
            (0, _jquery2.default)('#view-mode').hide();
            (0, _jquery2.default)('#work-mode').show();
            this.cy.nodes().lock();
            (0, _jquery2.default)('#trivial').css('background-color', 'transparent');
        }
    }]);
...
(0, _jquery2.default)('#work-mode').on('click', function () {
    cy.workMode();
});

(0, _jquery2.default)('#view-mode').on('click', function () {
    cy.viewMode();
});

(0, _jquery2.default)('#save-position').on('click', function () {
    console.log("savePosition []");
    cy.savePosition();
});

(0, _jquery2.default)('#load-position').on('click', function () {
