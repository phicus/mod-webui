...
%rebase("layout", title='Trivial for hosts/services', css=['trivial/css/trivial.css', 'trivial/css/cytoscape.js-panzoom.css', 'trivial/css/cytoscape.js-navigator.css'], js=['trivial/js/cytoscape-navigator.js', 'trivial/js/cytoscape-panzoom.js', 'trivial/js/trivial-style.js','trivial/js/trivial.js', 'trivial/js/cola.js', 'trivial/js/cytoscape-cola.js'], breadcrumb=[ ['Trivial All hosts', '/trivial'] ])
