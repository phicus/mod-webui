...
<nav class="header navbar navbar-static-top navbar-inverse navbar-fixed-top" role="navigation">
    ...
    <ul class="nav navbar-nav navbar-top-links navbar-right hidden-xs">
        ...
        <!--end-services-states-->
        <li><a href="/sonar" class="btn btn-ico" title="Sonar"><i class="fa fa-feed"></i></a></li>
        <li>
        ...
        <li class="dropdown">
            ...
            <ul class="dropdown-menu">
                ...
                <li class="dropdown-header" id="beta-features">
                    <label>Beta Features&nbsp;
    ...
    <div class="navbar-default sidebar" role="navigation">
        <div class="sidebar-nav navbar-collapse collapse">
            <ul class="nav" id="sidebar-menu">
                ...
                <!--%include("_filters.tpl")-->
                %if app:
                <li><a href="{{ app.get_url('Dashboard') }}"><span class="fa fa-dashboard sidebar-icon font-unknown"></span> Dashboard</a></li>
                <li><a href="{{ app.get_url('Problems') }}"><span class="fa fa-exclamation-circle sidebar-icon font-critical"></span> Problems</a></li>
                <li class="divider"></li>
                <!--<li>Groups and tags</li>-->
                <li>
                    <a href="#"><i class="fa fa-sitemap sidebar-icon"></i> Groups and tags <i class="fa arrow"></i></a>
                ...
                <li>
                    <a href="#"><i class="fa fa-bar-chart sidebar-icon"></i> Tactical views<i class="fa arrow"></i></a>
                    <ul class="nav nav-second-level">
                        <script>
                ...
                <li>
                    <a href="#"><i class="fa fa-gears sidebar-icon"></i> System<i class="fa arrow"></i></a>
                    <ul class="nav nav-second-level">
                ...
                <li>
                    <a href="#"><i class="fa fa-wrench sidebar-icon"></i> Configuration<i class="fa arrow"></i></a>
                    <ul class="nav nav-second-level">
                ...
                %if len(other_uis) > 0:
                <li>
                    <a href="#"><i class="fa fa-rocket sidebar-icon"></i> External<i class="fa arrow"></i></a>
                    <ul class="nav nav-second-level">
                        %for c in other_uis:
                        <li><a href="{{c['uri']}}" target="_blank"><span class="fa fa-rocket sidebar-icon"></span> {{c['label']}}</a></li>
                        %end
                        <li><a href="/radius" target="_blank"><span class="fa fa-wifi sidebar-icon"></span> Radius</a></li>
                        <li><a href="/cdrs" target="_blank"><span class="fa fa-phone-square sidebar-icon"></span> CDRs table</a></li>
                    </ul>
                </li>
                %end
                %end
